...
public class PerformanceDkAljcgzMx{
    ...
    private String ffrq;
    private String dqrq;
    private Short wjflbz;
    private Short ncwjflbz;
    private String ywzl;
    private String zzqxrq;
    private BigDecimal ll;
    private BigDecimal fcbl;
    private BigDecimal cldj;
    private BigDecimal cldw;
    private BigDecimal clgz;
    private BigDecimal zldj;
    private BigDecimal zldw;
    private BigDecimal zlgz;
    private BigDecimal cldkye;
    private BigDecimal ymdj;
    private BigDecimal ymdw;
    private BigDecimal ymgz;
    private String zzjc;			//组织简称，数据库表无
	...
	public Short getWjflbz() {
		return wjflbz;
	}
	public Short getNcwjflbz() {
		return ncwjflbz;
	}
	...
	public BigDecimal getCldkye() {
		return cldkye;
	}
	public BigDecimal getYmdj() {
		return ymdj;
	}
	public BigDecimal getYmdw() {
		return ymdw;
	}
	public BigDecimal getYmgz() {
		return ymgz;
	}
	...
	public void setWjflbz(Short wjflbz) {
		this.wjflbz = wjflbz;
	}
	public void setNcwjflbz(Short ncwjflbz) {
	...
	public void setCldkye(BigDecimal cldkye) {
		this.cldkye = cldkye;
	}
	public void setYmdj(BigDecimal ymdj) {
		this.ymdj = ymdj;
	}
	public void setYmdw(BigDecimal ymdw) {
		this.ymdw = ymdw;
	}
	public void setYmgz(BigDecimal ymgz) {
		this.ymgz = ymgz;
	}
