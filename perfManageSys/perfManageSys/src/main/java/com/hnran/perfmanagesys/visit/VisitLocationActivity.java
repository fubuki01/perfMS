...
public class VisitLocationActivity extends Activity implements SensorEventListener,OnGetGeoCoderResultListener {
    private static final int LOCATION_RESULT_CODE = 2;
    // 定位相关
    ...
    String locationResult = "";//关闭页面时返回到开启页面的地理位置的结果
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
        ...
        mBaiduMap.setMapStatus(MapStatusUpdateFactory.newLatLng(result
                .getLocation()));
        locationResult = result.getAddress();
    }
