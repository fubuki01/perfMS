...
import com.hnran.perfmanagesys.adapter.CustomerProductEtcAdapter;
...
public class CustomerProductEtcActivity extends BaseActivity{

	private RecyclerView mRecyclerView;
	
	private CustomerProductEtcAdapter customerProductEtcAdapter;
	...
	protected void initVariables() {
		...
		customerProductEtcAdapter = new CustomerProductEtcAdapter(etcCustomerFamilys);
	}
	...
	protected void initViews(Bundle savedInstanceState) {
		...
		mRecyclerView.setAdapter(customerProductEtcAdapter);
	...
	protected void loadData() {
		...
		String url = MakeUrl.makeURL(new String[]{"responseEtcCustomerJson.action"});
		...
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				...
				try{
					etcCustomerFamilys = JSON.parseArray(response, EtcCustomerFamily.class);
				}catch(JSONException e){
					e.printStackTrace();
				}
				Log.d("tt", etcCustomerFamilys.toString());
	...
	protected void notifyView() {
		// TODO Auto-generated method stub
		customerProductEtcAdapter.setData(etcCustomerFamilys);
		customerProductEtcAdapter.notifyDataSetChanged();
	}
