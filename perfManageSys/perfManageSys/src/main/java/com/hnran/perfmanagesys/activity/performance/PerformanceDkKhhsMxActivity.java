...
public class PerformanceDkKhhsMxActivity extends PerformanceCommonActivity{
	...
	protected void loadData() {
		// TODO Auto-generated method stub
		super.loadData();
		String url = MakeUrl.makeURL(new String[]{"findPerformanceDkKhhsMx.action"});
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				...
				try{
					...
					final List<PerformanceDkKhhsMx> list = JSON.parseArray(array.toString(), PerformanceDkKhhsMx.class);

					if(adapter == null){
						adapter = new PerformanceDkKhhsMxAdapter();
...
//							for(PerformanceDkKhhsMx l : list){
//								b = b.add(l.getGz());
//							}
//							total = b + "";
