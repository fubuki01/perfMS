...
import com.hnran.perfmanagesys.adapter.PerformanceMonthPhjfkAdapter;
...
public class PerformanceMonthPhjfkActivity extends PerformanceMonthCommonActivity{
	...
	protected void loadData() {
		...
		String url = MakeUrl.makeURL(new String[]{"findPerformancePhjfkgzMxCustom.action"});
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				...
				try{
					...
					final List<PerformancePhjfkgzMxCustom> list = JSON.parseArray(response, PerformancePhjfkgzMxCustom.class);
					adapter = new PerformanceMonthPhjfkAdapter(list);
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							for(PerformancePhjfkgzMxCustom l : list){
								b = b.add(l.getZbgz());
							}
							total = b + "";
