...
import com.hnran.perfmanagesys.adapter.PerformanceEtcHsgzMxAdapter;
...
public class PerformanceDianziEtcActivity extends PerformanceCommonActivity{
	...
	protected void loadData() {
		// TODO Auto-generated method stub
		super.loadData();
		String url = MakeUrl.makeURL(new String[]{"findPerformanceEtcHsgzMx.action"});
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				...
				try{
					...
					final List<PerformanceEtcHsgzMx> list = JSON.parseArray(array.toString(), PerformanceEtcHsgzMx.class);
					if(adapter == null){
						adapter = new PerformanceEtcHsgzMxAdapter();
...
//							for(PerformanceEtcHsgzMx l : list){
//								b = b.add(l.getGz());
//							}
//							total = b + "";
