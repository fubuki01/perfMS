...
public class PerformanceDaikuanYingxiaoActivity extends PerformanceCommonActivity{

	public final static int BISHU = 1;
	public final static int EDU = 2;
	...
	protected void loadData() {
		// TODO Auto-generated method stub
		super.loadData();
		String url = MakeUrl.makeURL(new String[]{"findPerformanceDkkhbsMx.action"});
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				...
				try{
					...
					final List<PerformanceDkkhbsMx> list = JSON.parseArray(array.toString(), PerformanceDkkhbsMx.class);
					if(adapter == null){
						adapter = new PerfDkkhbsMxAdapter(type);
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							for(PerformanceDkkhbsMx l : list){
								if(type == PerformanceDaikuanYingxiaoActivity.BISHU)
									b = b.add(l.getBsgz());
								else if(type == PerformanceDaikuanYingxiaoActivity.EDU)
									b = b.add(l.getEdgz());
							}
							total = b + "";
