...
import com.hnran.perfmanagesys.adapter.PerformanceDkAljcgzMxAdapter;
...
public class PerformanceDkAljcgzMxActivity extends PerformanceCommonActivity{
	...
	protected void loadData() {
		// TODO Auto-generated method stub
		super.loadData();
		String url = MakeUrl.makeURL(new String[]{"findPerformanceDkAljcgzMx.action"});
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				...
				try{
					...
					final List<PerformanceDkAljcgzMx> list = JSON.parseArray(array.toString(), PerformanceDkAljcgzMx.class);

					if(adapter == null){
						adapter = new PerformanceDkAljcgzMxAdapter();
...
//							for(PerformanceDkAljcgzMx l : list){
//								b = b.add(l.getYmgz());
//							}
//							total = b + "";
