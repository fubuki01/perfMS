...
import com.hnran.perfmanagesys.adapter.CustomerProductShoujiAdapter;
...
public class CustomerProductShoujiActivity extends BaseActivity{

	private RecyclerView mRecyclerView;

	private CustomerProductShoujiAdapter customerProductShoujiAdapter;

	private CellBankCustomer cellBankCustomers;
	...
	protected void initVariables() {
		...
		customerProductShoujiAdapter = new CustomerProductShoujiAdapter(cellBankCustomers);
	}
	...
	protected void initViews(Bundle savedInstanceState) {
		...
		mRecyclerView.setAdapter(customerProductShoujiAdapter);
	...
	protected void loadData() {
		...
		String url = MakeUrl.makeURL(new String[]{"responseCellBankCustomerJson.action"});
		...
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				...
				try{
					cellBankCustomers = JSON.parseObject(response, CellBankCustomer.class);
				}catch(JSONException e){
					e.printStackTrace();
				}

				Log.d("tt", cellBankCustomers.toString());
	...
	protected void notifyView() {
		// TODO Auto-generated method stub
		customerProductShoujiAdapter.setData(cellBankCustomers);
		customerProductShoujiAdapter.notifyDataSetChanged();
	}
