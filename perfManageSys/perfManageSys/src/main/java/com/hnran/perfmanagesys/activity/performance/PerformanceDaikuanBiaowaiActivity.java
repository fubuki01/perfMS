...
import com.hnran.perfmanagesys.adapter.PerformanceBlqsMxAdapter;
...
public class PerformanceDaikuanBiaowaiActivity extends PerformanceCommonActivity{
	...
	protected void loadData() {
		// TODO Auto-generated method stub
		super.loadData();
		String url = MakeUrl.makeURL(new String[]{"findPerformanceBlqsMx.action"});
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				...
				try{
					...
					final List<PerformanceBlqsMx> list = JSON.parseArray(array.toString(), PerformanceBlqsMx.class);
					if(adapter == null){
						adapter = new PerformanceBlqsMxAdapter();
