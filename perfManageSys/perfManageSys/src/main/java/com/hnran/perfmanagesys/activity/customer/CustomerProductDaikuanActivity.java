...
import com.hnran.perfmanagesys.adapter.CustomerProductDaikuanAdapter;
...
public class CustomerProductDaikuanActivity extends BaseActivity{

	private RecyclerView mRecyclerView;
	
	private CustomerProductDaikuanAdapter customerProductDaikuanAdapter;
	...
	protected void initVariables() {
		...
		customerProductDaikuanAdapter = new CustomerProductDaikuanAdapter(this, loanCustomerFamilys);
	}
	...
	protected void initViews(Bundle savedInstanceState) {
		...
		mRecyclerView.setAdapter(customerProductDaikuanAdapter);
	...
	protected void loadData() {
		...
		String url = MakeUrl.makeURL(new String[]{"responseLoanCustomerJson.action"});
		...
		StringRequest stringRequest = new StringRequest(Method.POST, url,  
			...
			public void onResponse(String response) {  
				Log.d("TAG", response);  
				loanCustomerFamilys = JSON.parseArray(response, LoanCustomerFamily.class);

				Log.d("tt", loanCustomerFamilys.toString());
	...
	protected void notifyView() {
		// TODO Auto-generated method stub
		customerProductDaikuanAdapter.setData(loanCustomerFamilys);
		customerProductDaikuanAdapter.notifyDataSetChanged();
	}
